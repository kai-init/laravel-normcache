...
final class RuntimeKillSwitchTest extends TestCase
{
    ...
    public function test_a_flag_set_by_another_process_is_observed_next_scope(): void
    {
        ...
        // Simulate a remote disable outside this scope's memo.
    ...
    public function test_a_flag_set_by_another_process_reaches_a_live_scope(): void
    {
        $read = fn() => RawPost::query()->toBase()->where('id', 1)->value('title');
        $this->assertSame('Before', $read());
        ...
        $this->assertCount(
            1,
            DB::getQueryLog(),
            'a kill switch must reach a live scope once the refresh interval lapses',
        );
    }
