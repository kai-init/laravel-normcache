...
final class SqlVolatilityScannerTest extends TestCase
{
    ...
    public static function volatileExpressions(): array
    {
        return [
            ...
            'SQL Server UTC clock' => ['GETUTCDATE()'],
            'SQL Server offset clock' => ['SYSDATETIMEOFFSET()'],
            'MySQL epoch clock' => ['UNIX_TIMESTAMP()'],
            'MySQL epoch conversion' => ['UNIX_TIMESTAMP(posts.created_at)'],
